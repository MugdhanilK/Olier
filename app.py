...
SYSTEM_MESSAGE_PLAIN = (
    ...
    "\n"
    "4 Aspects of the Divine Mother\n"
    ...
    "\n"
    "Note: Remember not to use the quotes directly. Use them as inspiration for your answers."
)
...
async def generate_description():
    ...
    preamble_for_gemini = "Your job is to produce a prompt for an image generation AI. Briefly outline a description of a colored painting that represents symbolically the key ideas of the following passage by Sri Aurobindo and the Mother. Be precise about the art style and techniques. Use archetypal images instead of being overly abstract. Your response should only contain the prompt to the imaged gen AI:"
